...
2. **Run quality gates** (if code changed) - Tests, linters, formatters, etc
3. **Smoke tests** run e2e smoke tests
...
6. **PUSH TO REMOTE** - This is MANDATORY:
   ...
   br sync --flush-only
   git add .beads/
   git commit -m "Landing changes for bead abc-123 - short description"
   git push
